...
if($name==$k)
{
	   ...
	   $result=mysql_query($sql3);
	   //echo $result;
		echo '<script type="text/javascript">window.location = "ldr.php"</script>';}
		else
		echo '<script type="text/javascript">
           window.location="KryptexPage28.php";
      </script>';  
}
	  else
		echo '<script type="text/javascript">
           window.location="KryptexPage29.php";
      </script>';  
?>