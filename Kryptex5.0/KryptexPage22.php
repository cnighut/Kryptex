...
$s=$_COOKIE['Username'];
echo $s?></span><span style="float:right;padding-right:50px">Level 22</span></div>
...
<div class="containerh teal borderYtoX">
   ...
   <p style="padding-top:30px;"></p>
<p style="text-align: center; font-size: 50px; color:white;"> Aparecium </p>
<p style="padding-bottom:50px"></p>
<!--
<div class="Row"> 
	<div class="Column">Kyant</div>
    <div class="Column">Nada</div>
    <div class="Column">Vardah</div>
    <div class="Column">?????</div>
</div>
-->
<p style="padding-bottom:50px"></p><form method="post" action="KryHide22.php" enctype="multipart/form-data">
