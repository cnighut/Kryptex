...
$s=$_COOKIE['Username'];
echo $s?></span><span style="float:right;padding-right:50px">Level 5</span></div>
...
<p style="padding-bottom:50px;text-align:center;color:white; padding-left:100px;padding-right:100px;"> I talk a lot isn't it?
Probably you might want me to shut up so that you could think hard and focus on solving this level!
But I just keep talking on!<br><br>Can't believe that I don't shut up!<br> Okay, now I won't speak much! Thank you! Come again. <br>I sound familiar, right?</p>
<!--Comments from setter A: Yes, yoou do, you idiot, but I hope the contestants get the right and much more famous guy rather than correctly identifying you.-->
<form method="post" action="KryHide5.php" enctype="multipart/form-data">
