...
if($name==$k||$name2==$k)
{
	   ...
	   $result=mysql_query($sql3);
	   //echo $result;
		echo '<script type="text/javascript">window.location = "KryptexPage11.php"</script>';
		}
		else
		echo '<script type="text/javascript">window.location="KryptexPage10.php";</script>';
}
	  else
		echo '<script type="text/javascript">
           window.location="KryptexPage10.php";
      </script>';  
?>