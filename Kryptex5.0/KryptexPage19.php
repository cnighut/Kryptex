...
$s=$_COOKIE['Username'];
echo $s?></span><span style="float:right;padding-right:50px">Level 19</span></div>
...
<div class="imgcont">
<img class="img-responsive" style="width:300px;height:300px;" src = "assets/images/Anubis.jpg"></img>
<img class="img-responsive" style="width:300px;height:300px;" src ="assets/images/JJ.jpg"></img>
<img class="img-responsive" style="width:300px;height:300px" src ="assets/images/Scythe.jpg"></img>
<img class="img-responsive" style="width:300px;height:300px" src ="assets/images/DeathQuetzalcoatl.jpg"></img>
<img class="img-responsive" style="width:300px;height:300px" src ="assets/images/qm.jpg"></img>
</div>
 <p style="padding-top:50px;text-align:center;color:white;padding-bottom:50px;padding-left:100px;padding-right:100px; font-size: 30px;">Wait for it!<br>
 It's going to be .......</p>
 <form method="post" action="KryHide19.php" enctype="multipart/form-data">
